...
female_caption <- paste0('**',str_replace_all(string = female_caption_data[2,3], pattern = ' ', replacement = ''),' Breast Cancer Screening Coverage**<br>',female_caption_data[2,1],' = ',female_caption_data[2,2],' years<br>',female_caption_data[1,1],' = ',female_caption_data[1,2],' years')
breast_plot <- ggplot(
  data = df_females,
...
#ggsave(breast_plot, filename = 'breast_cancer_screening.png', path = save_place, bg = 'transparent', units = 'mm', width = 235, height = 130)
