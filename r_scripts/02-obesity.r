...
# Fingertips-y stuff
inds <- indicators()
inds_obesity <- inds[grep('overweight',inds$IndicatorName),]

obesity_indicator <- 93088
...
df_to_plot_upper <- fingertips_data(IndicatorID = obesity_indicator, AreaTypeID = 102) %>% 
