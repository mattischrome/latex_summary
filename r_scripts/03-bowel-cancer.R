...
caption <- paste0('**',str_replace_all(caption_data[2,3],' ',''),' Bowel Cancer Screening**<br>',caption_data[2,1],' = ',caption_data[2,2],' years<br>',caption_data[1,1],' = ',caption_data[1,2],' years')
...
ggsave(bowel_plot, filename = 'bowel_cancer_screening.png', path = save_place, bg = 'transparent', units = 'mm', width = 235, height = 130)
