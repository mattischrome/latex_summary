...
### WSX/ENG/CIPFA B18b people who use services pg 65
### WSX/ENG/CIPFA B18b % of carers pg 65
### WSX/ENG/CIPFA B18b % of carers pg 65

### MY VARIABLES
XXXX <- 90638
  YYYY <- "Social Isolation: percentage of adult carers \nwho have as much social contact as they would like"
ZZZZ <- "social_isolation"
